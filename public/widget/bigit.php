...
MYTZ="?tz=$timezone"
test "$fontcol" = "" && fontcol=000
test "$bgcol" = "" && bgcol=FFF
...
<script>
	...
	function doTime() {
		...
		$SEC decsLabel.innerHTML = '.'+Math.floor(totalSeconds/10)%10;
...
<body style="font-family:monospace; padding:0; margin:0; background-color:#$bgcol; color:#$fontcol;">
...
<p style="font-size:55px; margin:0;"><label id="hours" style="font-size:55px;">--</label>:<label id="minutes" style="font-size:55px;">--</label>:<label id="seconds" style="font-size:55px;">--</label><label id="decs" style="font-size:36px;">-</label></p>
$WEEKDAY
<script>
...
$SEC var decsLabel = document.getElementById("decs");
